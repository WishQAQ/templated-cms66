...
getAjaxValueByNewsId:function(infoId,infoStatus,showDegree,showMessageCount,showQuestionTag,degreeStr,mesStr,quesStr){
	if(infoStatus){
	$.post("../../FrontNews.do.htm", "method=getAjaxValueByNewsId&newsId="+infoId+"&infoStatus="+infoStatus+"&showDegree="+showDegree+"&showMessageCount="+showMessageCount+"&showQuestionTag="+showQuestionTag, function(res){
		// res = fail|0|0
